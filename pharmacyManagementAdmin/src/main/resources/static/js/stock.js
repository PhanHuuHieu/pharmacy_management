            ...
            function validateStock() {
            	if($('#fk_product_id').val() === ''){
            		$("#btnSb").prop( "disabled", true );
            		$("#error").text("Mã sản phẩm đang trống!");
            	} else if($('#stock_name').val() === ''){
            		$("#btnSb").prop( "disabled", true );
            		$("#error").text("Tên kho đang trống!");
            	} else if($('#datePost').val() === ''){
            		$("#btnSb").prop( "disabled", true );
            		$("#error").text("Ngày tạo đang trống!");
            	} else {
